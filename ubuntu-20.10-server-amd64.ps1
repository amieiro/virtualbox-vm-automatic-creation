...
# https://mirrors.xmission.com/ubuntu-cd/20.10/ubuntu-20.10-live-server-amd64.iso

# Set some variables
$env:path = "C:\Program Files\Oracle\VirtualBox;$env:path"

$vmName = "ubuntu-20.10-server-amd64"
$osType = "Ubuntu_64" 
$vmPath = "$home\VirtualBox VMs"
$vmDiskName = "$vmName.vdi"
$vmDiskPath = "$vmPath\$vmName\$vmDiskName"
$graphicscontroller = "none"
$isoFile = "$home\ISO\ubuntu-20.10-live-server-amd64.iso"
$username = "usuario"
$password = "usuario"
$diskSikze = 30720
$diskFormat = "VDI"
